...
presetup() {
    ...
    pushd ./../artifacts/src/github.com/orgtmp2/go
...
CHANNEL_NAME="myorgchannel2"
CC_RUNTIME_LANGUAGE="golang"
VERSION="1"
CC_SRC_PATH="./../artifacts/src/github.com/orgtmp2/go"
CC_NAME="orgtmp2"
...
packageChaincode() {
    ...
    echo "===================== Chaincode is packaged on peer0.org1(Endorsing Peer) ===================== "
}
#packageChaincode
...
installChaincode() {
    ...
    echo "===================== Chaincode is installed on peer0.org1(Endorsing Peer) ===================== "
...
# run both queries simuntaniously ie queryInstalled and approveForMyOrg to avoid error in approve for org
#queryInstalled
#approveForMyOrg1
...
commitChaincodeDefination() {
    setGlobalsForPeer0Org1
    peer lifecycle chaincode commit -o 172.105.37.91:7050 --ordererTLSHostnameOverride orderer.example.com \
        --tls $CORE_PEER_TLS_ENABLED --cafile $ORDERER_CA \
        --channelID $CHANNEL_NAME --name ${CC_NAME} \
        --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_ORG1_CA \
        --peerAddresses 192.46.211.190:9051 --tlsRootCertFiles $PEER0_ORG2_CA \
